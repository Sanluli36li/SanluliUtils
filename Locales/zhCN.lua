...
L["addons.title"] = "插件增强"
L["automatic.autoCancelLFGApplication.message"] = "已取消申请\"%s\", 因为选定的职责已满"
L["automatic.autoCancelLFGApplication.title"] = "自动取消队伍申请"
L["automatic.autoCancelLFGApplication.tooltip"] = "在预创建队伍/集合石插件中，自动取消你选定的职责都已满员的申请\n\n只对史诗钥石地下城生效\n\n受限于暴雪API，满员时申请不会立刻被取消，而是在你选择下一个队伍时取消"
