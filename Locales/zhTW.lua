...
L["addons.title"] = "插件增強"
L["automatic.autoCancelLFGApplication.message"] = "已取消申請「%s」，因為選定的職責已滿"
L["automatic.autoCancelLFGApplication.title"] = "自動取消隊伍申請"
L["automatic.autoCancelLFGApplication.tooltip"] = "在預創隊伍中，當你選擇的職責都已滿員時，自動取消你的申請\n\n只對傳奇鑰石地城生效\n\n受限於暴雪API，隊伍滿員時申請不會立刻被取消，而是在你選擇下一個隊伍時取消"
...
L["automatic.unequipTeleportEquipment.message"] = "已自動卸下傳送裝備: %s"
L["automatic.unequipTeleportEquipment.message.noPrevious"] = "你目前裝備著傳送物品%s，請記得更換"
L["automatic.unequipTeleportEquipment.title"] = "自動卸下傳送裝備"
L["automatic.unequipTeleportEquipment.tooltip"] = "在使用傳送後，自動卸下身上的傳送裝備"
