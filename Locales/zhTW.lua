...
L["client.title"] = "客戶端"
L["general.autoCombatlog.dungeon.title"] = "地下城難度"
L["general.autoCombatlog.dungeon.tooltip"] = "需要自動開啓戰鬥日志的地下城難度"
L["general.autoCombatlog.raid.title"] = "團隊副本難度"
L["general.autoCombatlog.raid.tooltip"] = "需要自動開啓戰鬥日志的團隊副本難度"
L["general.autoCombatlog.title"] = "自動戰鬥日志"
L["general.autoCombatlog.tooltip"] = "進入副本時自動開啓戰鬥日志\n\n戰鬥日志將保存在\"Logs/WoWCombatLog\"中\n|cffff0000只有當你需要保存戰鬥日志時才應該開啓此功能(例如上傳到WarcraftLogs或raider.io等)\n戰鬥日志會占用磁盤空間, 請定期清理|r\n|cffffffff在激活了經典分配規則的副本中不生效|r"
...
L["social.chat.hyperlinkEnhance.displayIcon.title"] = "顯示圖標"
L["social.chat.hyperlinkEnhance.displayIcon.tooltip"] = "在物品、法術、坐騎超鏈接前加入它們的圖標"
L["social.chat.hyperlinkEnhance.displayItemLevel.title"] = "顯示物品等級"
L["social.chat.hyperlinkEnhance.displayItemLevel.tooltip"] = "在物品超鏈接前顯示其等級"
L["social.chat.hyperlinkEnhance.displayItemType.title"] = "顯示物品分類"
L["social.chat.hyperlinkEnhance.displayItemType.tooltip"] = "在物品超鏈接前顯示其分類"
L["social.chat.hyperlinkEnhance.title"] = "超鏈接增强"
L["social.chat.hyperlinkEnhance.tooltip"] = "在聊天信息的超鏈接添加更多信息"
L["social.chat.hyperlinkEnhance.displaySockets.title"] = "顯示插槽"
L["social.chat.hyperlinkEnhance.displaySockets.tooltip"] = "在物品超鏈接后顯示插槽信息"
