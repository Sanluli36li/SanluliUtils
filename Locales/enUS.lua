...
L["general.autoSellJunk.method.blizzard.tooltip"] = "When you open the merchant interface, all junk will be sold. And they will not appear in the buyback interface(Using Blizzard's built-in method, it is equivalent to clicking the Sell All Junk button and confirming)"
