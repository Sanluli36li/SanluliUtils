...
L["automatic.autoCancelLFGApplication.message"] = "Canceled application to \"%s\" because the selected roles are full"
L["automatic.autoCancelLFGApplication.title"] = "Auto Cancel LFG Application"
L["automatic.autoCancelLFGApplication.tooltip"] = "Automatically cancels your application to a premade group when all the roles you selected are already filled.\n\nOnly works for Mythic Keystone dungeons.\n\nDue to Blizzard API limitations, the application will not be canceled immediately when the group is full, but will be canceled when you select the next group."
